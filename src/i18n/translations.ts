...
export const translations = {
  en: {
    ...
    stack: {
      ...
      categories: [
        { label: 'Frontend', tags: ['TypeScript', 'React', 'Next.js', 'TailwindCSS', 'shadcn/ui'] },
        { label: 'Backend', tags: ['Node.js', 'Express', 'GraphQL', 'REST APIs', 'Prisma'] },
        { label: 'Databases', tags: ['PostgreSQL', 'MySQL', 'MongoDB', 'Firebase Firestore'] },
        { label: 'AI', tags: ['LLMs', 'RAG', 'MCP', 'n8n', 'Prompt Engineering', 'Agents'], accent: true as const },
        { label: 'DevOps', tags: ['Git', 'Docker', 'Vercel', 'GitHub Actions', 'CI/CD'] },
      ],
    },
    experience: {
      label: 'Experience',
      ...
      entries: [
        {
          ...
          description: 'Building AI pipelines to automate B2B operations. LLMs in production, not in demo.',
        },
        {
          company: 'Tackr',
          dates: '2023 – 2025',
        ...
        },
        {
          ...
          description: 'Client-side React projects and .NET Core APIs for diverse clients.',
        },
        {
          company: 'Freelance',
          dates: '2022 – 2023',
  ...
  es: {
    ...
    stack: {
      ...
      categories: [
        { label: 'Frontend', tags: ['TypeScript', 'React', 'Next.js', 'TailwindCSS', 'shadcn/ui'] },
        { label: 'Backend', tags: ['Node.js', 'Express', 'GraphQL', 'REST APIs', 'Prisma'] },
        { label: 'Bases de datos', tags: ['PostgreSQL', 'MySQL', 'MongoDB', 'Firebase Firestore'] },
        { label: 'IA', tags: ['LLMs', 'RAG', 'MCP', 'n8n', 'Prompt Engineering', 'Agentes'], accent: true as const },
        { label: 'DevOps', tags: ['Git', 'Docker', 'Vercel', 'GitHub Actions', 'CI/CD'] },
      ],
    },
    experience: {
      ...
      entries: [
        {
          ...
          role: 'Software Developer',
          description: 'Construyendo pipelines de IA para automatizar operaciones B2B. LLMs en producción, no en demo.',
        },
        {
          company: 'Tackr',
          dates: '2023 – 2025',
        ...
        },
        {
          ...
          description: 'Proyectos client-side en React y APIs con .NET Core para clientes diversos.',
        },
        {
          company: 'Freelance',
          dates: '2022 – 2023',
